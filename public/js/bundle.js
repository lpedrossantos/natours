...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibHBzcyIsImEiOiJjazd2c2ZsaHYxYWVrM2xwZ2FudWg3cWJoIn0.aHD-KTh2kpCMEvjmxnguCA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/lpss/ck7vszjhq0xgu1imtt4uc3omk',
    scrollZoom: false //center: [-117.953053, 34.084196],
    //zoom: 6
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') window.location.replace('http://127.0.0.1:3000/');
            _context2.next = 11;
            break;
...
exports.changeUserPhoto = exports.updateUserData = void 0;
...
var changeUserPhoto = /*#__PURE__*/function () {
  ...
  return function changeUserPhoto(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.changeUserPhoto = changeUserPhoto;
...
var stripe = Stripe('pk_test_fnIxLBKoQgZWs8HGaylFpWpM00VqA7OZHc');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2) Ceate checkout form + charge credit card
...
if (updateForm) {
  ...
  document.querySelector('.form__upload').addEventListener('change', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return (0, _updateSettings.changeUserPhoto)(form);

            case 4:
              resObj = _context.sent;

              if (resObj.data.status === 'success') {
                document.querySelector('.form__user-photo').src = "/img/users/".concat(resObj.data.data.user.photo);
              }
  ...
  updateForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateUserData)(newForm, 'data');
  });
}
